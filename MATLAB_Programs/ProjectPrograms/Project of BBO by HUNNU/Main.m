...
str025='017';         % 修改你需要放置的子文件夹的名称
folderName025=str025;
% folderName030=str030;   可以删除
folderParentPath01=(['.\MATLAB_Programs\ProjectPrograms\Project of BBO by HUNNU\Export Data']);
...
MainOPTIONS.popsize = 10; % total population size 个体总数量
MainOPTIONS.Maxgen = 250; % generation count limit max number of gene  生成后代代数限制
...
MainOPTIONS.TimesOfMonte = 5; % times of Monte    蒙特卡罗模拟次数
...
for i=1:n
    ...
    % Export
    ExportData.MeanCPUTime=MeanCPUTime;
    ExportData.MeanMinCost=MeanMinCost;
    ExportData.BestMinCost=BestMinCost;
