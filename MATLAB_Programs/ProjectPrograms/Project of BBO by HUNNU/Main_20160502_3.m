...
for i=1:n
    ...
    % Export
    ExportData.Details.MeanCPUTime=MeanCPUTime;
    ExportData.Details.MeanMinCost=MeanMinCost;
    ExportData.Details.BestMinCost=BestMinCost;
