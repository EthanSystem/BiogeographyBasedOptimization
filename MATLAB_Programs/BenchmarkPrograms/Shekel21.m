function [InitFunction, CostFunction, FeasibleFunction] = Shekel21
InitFunction = @Shekel21Init;
CostFunction = @Shekel21Cost;
FeasibleFunction = @Shekel21Feasible;
%原则上只允许一个解中只有5个变量
return;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [MaxParValue, MinParValue, Population, OPTIONS] = Shekel21Init(OPTIONS)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Population] = Shekel21Cost(OPTIONS, Population)

% Compute the cost of each member in Population
%原则上只允许一个解中只有5个变量，
global MinParValue MaxParValue
popsize = OPTIONS.popsize;
p = 5;%OPTIONS.numVar=5
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [Population] = Shekel21Feasible(OPTIONS, Population)
